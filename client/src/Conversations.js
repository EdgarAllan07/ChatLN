...
function Conversations({ username, socket, room }) {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (cuadroRef.current && !cuadroRef.current.contains(event.target)) {
  ...
  return (
    <div class="app-left">
      ...
      <div class="app-profile-box">
        ...
        <div class="app-profile-box-name">{username}</div>
        <button class="btn btn-primary" onClick={Cuadro}>
          <i class="fa-solid fa-circle-info fa-lg"></i>
        </button>
        <div ref={cuadroRef} class="cuadro-texto">
          <ul>
            <li></li>
            <li></li>
            <li></li>
  ...
  {userList.map((user) => (
    <li key={user.id} className="chat-list-item active">
      <img src="https://images.vexels.com/media/users/3/263623/isolated/preview/d262ff89785ec8364e39438250c1804f-personaje-de-dab-de-astronauta-de-bitcoin.png" />
